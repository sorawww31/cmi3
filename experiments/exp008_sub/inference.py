...
# ユーザー設定（ここだけ変更する）
# ==============================================================================
SRC_DATASET = "/kaggle/input/datasets/sorawww31/exp007-scale/experiments"  # ソースコード用データセット名
MODEL_DATASET = (
    "/kaggle/input/datasets/sorawww31/exp007-scale/output"  # モデル用データセット名
)
MODEL_VERSION = "013_revise"  # モデルバージョン
